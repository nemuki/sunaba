        ...
        <script>{`
          function handleSubmit() {
            ...
            if (!hasErrors) {
              ...
              successDiv.innerHTML = '<div style="background-color: #d4edda; border: 1px solid #c3e6cb; color: #155724; padding: 12px; border-radius: 4px; margin-top: 20px;"><strong>✓ 入力が正常です！</strong><br>URL: ' + url + '<br>名前: ' + name + '<br><em>TODO: iCal生成処理を実装予定</em></div>';
